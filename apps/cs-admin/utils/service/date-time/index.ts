...
export const TimeOption = { hour: "2-digit", minute: "2-digit", second: "2-digit" };
...
export const formatTime = (timeStamp: string) => {
  ...
  const formatedDate = date
    ...
    .replace(/\./g, " ");
  const formatedTime = date.toLocaleTimeString("en-US", TimeOption as DateTimeFormatOptions);
