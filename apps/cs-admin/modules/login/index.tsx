...
const LoginModule = () => {
  return (
    <section className="flex flex-col lg:w-screen z-0 lg:h-screen bg-neutral-100 overflow-hidden">
      <Image src={asset1} alt="asset1" className="absolute right-[100px]" />
      <Image src={asset2} alt="asset2" className="absolute right-0" />
      ...
      <Image src={asset3} alt="asset3" className="absolute bottom-0 left-48" />
    </section>
  );
};
