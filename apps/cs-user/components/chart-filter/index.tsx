...
export const ChartFilter: FC = (): ReactElement => {
  ...
  return (
    <div className="flex flex-row gap-2 justify-center relative">
      <section>
        <div className="flex text-sm z-10">
          <Menu as="div" className="inline-block text-center ">
            ...
            >
              <Menu.Items className="snap-y absolute w-[100px] z-10">
      ...
      <section>
        <div>
          <Menu as="div" className=" text-center text-sm relative">
            <Menu.Button
              className={`${
                isActive === "Bulan"
                  ? "text-primary-400 border border-primary-500 "
      ...
      <section>
        <div className=" flex text-sm">
          <Menu as="div" className=" inline-block text-center relative">
            <Menu.Button
              className={`${
                isActive === "Minggu"
                  ? "text-primary-400 border border-primary-500 "
