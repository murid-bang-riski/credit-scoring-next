...
import { TUploadData } from './types';

export const IdentityScoringSection = () => {
  const [isOpen, setIsOpen] = useState(false);
  const [currentDialogData, setCurrentDialogData] =
    useState<TUploadData | null>(null);
  ...
  const upload: Array<TUploadData> = [
    ...
    },
    {
      ...
      status: errors.image_surat_nomor_pokok_wajib_pajak_perusahaan
        ? 'error'
        : 'none',
      notif:
              ...
              <div className="w-full flex flex-col gap gap-y-2">
                ...
                <div className="flex">
                  <div className="w-[60%]">
                    ...
                    <p>
                      2. Pastikan Foto yang diambil jelas dan tidak terlihat
                      buram
                    </p>
